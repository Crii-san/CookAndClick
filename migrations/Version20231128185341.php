 ...
 */
final class Version20231128185341 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Ingredient ADD id_ingredient INT AUTO_INCREMENT NOT NULL, ADD nom_ingredient VARCHAR(50) NOT NULL, ADD unite_mesure VARCHAR(50) NOT NULL, ADD description_ingredient VARCHAR(500) NOT NULL, DROP idAllergene, DROP nomIngredient, DROP uniteMesure, DROP descriprionIngredient, CHANGE calories calories INT NOT NULL, CHANGE idIngredient id_allergene_id INT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id_ingredient)');
        $this->addSql('ALTER TABLE Ingredient ADD CONSTRAINT FK_6BAF787027A51FC0 FOREIGN KEY (id_allergene_id) REFERENCES allergene (idAllergene)');
        $this->addSql('CREATE INDEX IDX_6BAF787027A51FC0 ON Ingredient (id_allergene_id)');
        ...
        $this->addSql('ALTER TABLE Utilisateur ADD id_util INT AUTO_INCREMENT NOT NULL, ADD id_allergene_id INT NOT NULL, ADD id_admin_id INT NOT NULL, ADD date_nais DATE NOT NULL, DROP idUtil, DROP idAllergene, DROP idAdmin, DROP dateNais, CHANGE nom nom VARCHAR(50) NOT NULL, CHANGE prenom prenom VARCHAR(50) NOT NULL, CHANGE email email VARCHAR(50) NOT NULL, CHANGE login login VARCHAR(50) NOT NULL, CHANGE tel tel VARCHAR(10) NOT NULL, CHANGE mdp mdp VARCHAR(100) NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id_util)');
        $this->addSql('ALTER TABLE Utilisateur ADD CONSTRAINT FK_1D1C63B327A51FC0 FOREIGN KEY (id_allergene_id) REFERENCES allergene (idAllergene)');
        $this->addSql('ALTER TABLE Utilisateur ADD CONSTRAINT FK_1D1C63B334F06E85 FOREIGN KEY (id_admin_id) REFERENCES administrateur (idAdmin)');
        $this->addSql('CREATE INDEX IDX_1D1C63B327A51FC0 ON Utilisateur (id_allergene_id)');
        $this->addSql('CREATE INDEX IDX_1D1C63B334F06E85 ON Utilisateur (id_admin_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE DetailRecetteIngredient (idDetail INT NOT NULL, idRecette INT NOT NULL, idIngredient INT NOT NULL, quantite INT DEFAULT NULL, INDEX CORRESPONDRE_FK (idIngredient), INDEX UTILISER_FK (idRecette), PRIMARY KEY(idDetail)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('DROP INDEX IDX_6BAF787027A51FC0 ON ingredient');
        $this->addSql('DROP INDEX `PRIMARY` ON ingredient');
        $this->addSql('ALTER TABLE ingredient ADD idAllergene INT DEFAULT NULL, ADD nomIngredient VARCHAR(50) DEFAULT NULL, ADD uniteMesure VARCHAR(50) DEFAULT NULL, ADD descriprionIngredient VARCHAR(500) DEFAULT NULL, DROP id_ingredient, DROP nom_ingredient, DROP unite_mesure, DROP description_ingredient, CHANGE calories calories INT DEFAULT NULL, CHANGE id_allergene_id idIngredient INT NOT NULL');
        ...
        $this->addSql('DROP INDEX IDX_1D1C63B327A51FC0 ON utilisateur');
        $this->addSql('DROP INDEX IDX_1D1C63B334F06E85 ON utilisateur');
        $this->addSql('DROP INDEX `PRIMARY` ON utilisateur');
        $this->addSql('ALTER TABLE utilisateur ADD idUtil INT NOT NULL, ADD idAllergene INT DEFAULT NULL, ADD idAdmin INT NOT NULL, ADD dateNais DATE DEFAULT NULL, DROP id_util, DROP id_allergene_id, DROP id_admin_id, DROP date_nais, CHANGE nom nom VARCHAR(50) DEFAULT NULL, CHANGE prenom prenom VARCHAR(50) DEFAULT NULL, CHANGE email email VARCHAR(50) DEFAULT NULL, CHANGE login login VARCHAR(50) DEFAULT NULL, CHANGE tel tel CHAR(10) DEFAULT NULL, CHANGE mdp mdp VARCHAR(100) DEFAULT NULL');
